...
export class FriendsComponent implements OnInit {
  ...
  constructor(private friendsExtractor: FriendsExtractorService, private cookie: CookieService) { }
  ...
  extract(){
    this.wait = true;
    this.friendsExtractor.extractFriends()
    .pipe(
      switchMap((data: Observable<any>)=>{return data;}),
      switchMap((data: any)=>{
